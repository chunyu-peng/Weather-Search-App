...
public class WeatherData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inf = inflater.inflate(R.layout.fragment_weather_data, container, false);
        if (getArguments() != null) {
            ...
            HIChartView chartView = inf.findViewById(R.id.hc);
            ...
            paneBackground1.setBackgroundColor(HIColor.initWithRGBA(90, 163, 0, 0.35));
            ...
            paneBackground3.setBackgroundColor(HIColor.initWithRGBA(253, 128, 94, 0.35));
            ...
            plotOptions.getSolidgauge().setDataLabels(new ArrayList<HIDataLabels>());
            ...
            try {
                humidity = Integer.parseInt(values.getString("humidity"));
                cloudCover = Integer.parseInt(values.getString("cloudCover"));
                precipitation = Integer.parseInt(values.getString("precipitationProbability"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
            ...
            data1.setColor(HIColor.initWithRGB(90, 163, 0));
            data1.setRadius("112%");
            ...
            data3.setColor(HIColor.initWithRGB(253, 128, 94));
            data3.setRadius("62%");
